    ...
    <div className="w-full relative">
      ...
      {designMode === "split" && (
        ...
        >
          ...
          <div className="wrap py-10 sm:py-14 w-full relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
              ...
              {/* Right Column: 100% Unobstructed School Photo Showcase (7 cols on lg) */}
              <div className="lg:col-span-7">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border-2 border-white/15 group aspect-[16/10] sm:aspect-[16/9] bg-slate-900">
                  ...
                  <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent p-3 sm:p-4 z-20 flex items-center justify-between">
                    <span className="text-xs text-white/95 font-medium truncate max-w-[85%]">
                      {activeSlide.title}
                    </span>
