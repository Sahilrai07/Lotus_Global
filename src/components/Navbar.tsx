  ...
  const navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { label: "Central Library & Sanctum", pageId: "facility-library" },
        { label: "Sports Arena & Athletics", pageId: "facility-sports" },
        { label: "Music & Performing Arts Studio", pageId: "facility-music" },
        { label: "Campus Infirmary & First-Aid", pageId: "facility-infirmary" },
      ],
    },
    {
      id: "admissions",
